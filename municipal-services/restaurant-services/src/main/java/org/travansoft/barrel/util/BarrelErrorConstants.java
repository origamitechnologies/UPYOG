package org.travansoft.barrel.util;

public class BarrelErrorConstants {
    ...
    public static final String ASSET_UNKNOWN_DATE = "BPA UNKNOWN DATE";

    public static final String ASSET_UNKNOWN_TIME = "BPA UNKNOWN TIME";

    public static final String ASSET_INVALID_ACTION = "BPA INVALID ACTION";
